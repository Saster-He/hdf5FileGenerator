...
label2 = label + 1
label_size = 1 * num_samples * height * width * length;
#label2 = np.arange(label_size)
#label2 = [0 for i in xrange(label_size)]
label2 = np.zeros(label_size)
label2 = label2.reshape(num_samples, 1, height, width, length)
