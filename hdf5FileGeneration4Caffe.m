...
delete('psO_train.hdf5')
delete('psO_test.hdf5')
% First write the train data
h5create('psO_train.hdf5','/data',[featureLen,len-100],'Datatype','double');
h5write('psO_train.hdf5','/data',train_data');
h5create('psO_train.hdf5','/label',[1,len-100],'Datatype','double');
h5write('psO_train.hdf5','/label',train_labels');
% now write the test data
h5create('psO_test.hdf5','/data',[featureLen,100],'Datatype','double');
h5write('psO_test.hdf5','/data',test_data');
h5create('psO_test.hdf5','/label',[1,100],'Datatype','double');
h5write('psO_test.hdf5','/label',test_labels');
